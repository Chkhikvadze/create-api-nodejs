...
var debug = require('debug')('<%= debugApi %>-userController');
...
var _USER_ACTIVATION_CALLBACK_URL = '<%= USER_ACTIVATION_CALLBACK_URL %>';
var _USER_FORGOT_CALLBACK_URL = '<%= USER_FORGOT_CALLBACK_URL %>';
